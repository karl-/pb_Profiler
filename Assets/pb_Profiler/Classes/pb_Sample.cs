...
namespace Parabox.Debug
{
	...
	public class pb_Sample
	{
		...
		{
			stackTrace = new StackTrace(stackOffset, true);
			// StackFrame sf = stackTrace.GetFrame(0);
			// string c = System.IO.Path.GetFileNameWithoutExtension(sf.GetFileName()) + "::" + sf.GetMethod().Name + " - " + sf.GetFileLineNumber();
		...
		public void GetFileAndLine(out string file, out int line)
		{
